;;;; rcirc-notify.el -- libnotify popups with some enhancements for notify-send
;; Copyright (c) 2011 Olivier Sirven
...
;;
;;;; Changelog:
;; * 2011/02/14 - Add some configuration variables for notify-send
;;
...
(defvar my-rcirc-notify-expire-time 5000
  "Number of milliseconds that will elapse before the notification expires.")

(defvar my-rcirc-notify-send-icon "/usr/share/pixmaps/gnome-irc.png"
  "Icon to use for notify-sent tool")
  ...
  (cond
    ((executable-find "notify-send")
     (start-process "page-me" nil
                    ...
                    "-i" (if my-rcirc-notify-send-icon my-rcirc-notify-send-icon "gtk-dialog-info")
                    "-t" (int-to-string my-rcirc-notify-expire-time) "rcirc"
                    msg))
